  ...
  <main class="main-content">
    ...
    <div class="empty-state-hero">
      <div class="empty-hero-cards">
        <div class="empty-hero-card"></div>
        <div class="empty-hero-card"></div>
        <div class="empty-hero-card"></div>
      </div>
      <h2 class="empty-state-title">Kandang dalam keadaan baik</h2>
      <p class="empty-state-text">Tidak ditemukan kendala di dalam kandang</p>
    </div>
